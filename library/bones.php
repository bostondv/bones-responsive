...
function bones_queue_low_js_and_css() {
  if (!is_admin()) {
    ...
    wp_register_style( 'bones-responsive', get_template_directory_uri() . '/library/css/style.css', array(), filemtime(get_template_directory() . '/library/css/style.css'), '(min-width:481px)' );
